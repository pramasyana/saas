...
Route::apiResource('/financing/costs', CostController::class)->except(['show']);

Route::apiResource('/financing/categories', CostCategoryController::class)->except(['show', 'index']);
