...
export default function ServiceDeleteDialog({ open, service, deleting, error, onClose, onConfirm }: ServiceDeleteDialogProps) {
    if (!open) {
        return null;
    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm animate-[fade-up_0.3s_ease-out] rounded-2xl bg-white p-6 shadow-2xl">
                ...
                <p className="mb-6 text-center text-sm text-neutral-600">
                    Apakah Anda yakin ingin menghapus <strong className="text-neutral-900">{service.name}</strong>?
                    <br />
