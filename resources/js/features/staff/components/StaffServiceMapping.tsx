        ...
        <div>
            <div className="mb-4 flex items-center gap-2.5 border-b border-neutral-200 pb-4">
                ...
                <div>
                    ...
                    <p className="text-xs text-neutral-500">Pilih layanan dan atur persentase incentive per staff.</p>
                </div>
            </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex min-w-0 flex-1 items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            <p className="truncate text-sm font-medium text-neutral-900">{svc.name}</p>
                                            {svc.duration && (
                                        ...
                                        <div className="ml-3 flex shrink-0 items-center gap-3">
                                            <div className="flex items-center gap-1.5">
                                                <input
                                                    ...
                                                    className="w-16 rounded-md border border-neutral-200 bg-white px-2 py-1 text-right text-xs font-medium text-neutral-700 shadow-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/20"
                                                />
