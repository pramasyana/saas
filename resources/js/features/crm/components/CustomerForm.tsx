...
export default function CustomerForm({ customer, saving, errors = {}, onSave, onCancel }: CustomerFormProps) {
    ...
    useEffect(() => {
        if (customer) {
            ...
            setForm({ name: '', email: '', phone: '', company: '', address: '', birthday: '', is_active: true });
        }
    }, [customer]);
            ...
            <div>
                <div className="flex items-center gap-2.5 border-b border-neutral-200 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-neutral-500">Data dasar pelanggan.</p>
                    </div>
                </div>
                <div className="mt-5 grid gap-5 sm:grid-cols-2">
                    ...
                    <div>
                        {renderField('Perusahaan', 'company', (
                            <div className="relative">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                    <svg className="h-4 w-4 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                    ...
                    <div>
                        {renderField('Tanggal Lahir', 'birthday', (
                            <div className="relative">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5">
                                    <svg className="h-4 w-4 text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                                ...
                                <input
                                    ...
                                    className={inputClass('birthday', 'pl-10')}
                                />
                            </div>
                        ))}
                    </div>
            ...
            <div>
                <div className="flex items-center gap-2.5 border-b border-neutral-200 pb-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-neutral-500">Tentukan status pelanggan.</p>
                    </div>
                </div>
                <div className="mt-5">
                        ...
                        <div className="flex items-start gap-3.5">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs text-neutral-500">
                                    {form.is_active ? 'Pelanggan ini aktif.' : 'Pelanggan ini tidak aktif.'}
                                </p>
                            </div>
                        </div>
                ...
                <Button type="submit" disabled={saving} className="min-w-[120px]">
                    {saving ? (
                        <span className="inline-flex items-center gap-2">
                            ...
                            {customer ? 'Menyimpan...' : 'Menambahkan...'}
                        </span>
                    ) : (
                        <span className="inline-flex items-center gap-2">
                            {customer ? (
