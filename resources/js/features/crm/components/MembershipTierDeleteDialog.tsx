...
import type { MembershipTier } from '@/features/crm/types';

interface MembershipTierDeleteDialogProps {
    open: boolean;
    tier: MembershipTier;
    deleting: boolean;
    error?: string;
...
export default function MembershipTierDeleteDialog({ open, tier, deleting, error, onClose, onConfirm }: MembershipTierDeleteDialogProps) {
    if (!open) {
return null;
}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm animate-[fade-up_0.3s_ease-out] rounded-2xl bg-white p-6 shadow-2xl">
                ...
                <h3 className="mb-1 text-center text-lg font-semibold text-neutral-900">
                    Hapus Membership Tier
                </h3>
                <p className="mb-6 text-center text-sm text-neutral-600">
                    Apakah Anda yakin ingin menghapus tier <strong className="text-neutral-900">{tier.name}</strong>?
                    <br />
