...
const notificationNavItems = [
    ...
    {
        label: 'Notif. Tenant',
        href: '/admin/tenant-notifications',
        icon: (
            <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.7V9A6 6 0 006 9v.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" />
            </svg>
...
const systemNavItems = [
    {
        ...
        icon: (
            <svg className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-6.622-6.624a9.001 9.001 0 0112.385-3.684 8.998 8.998 0 014.234 7.951 9 9 0 01-8.775 9.002 9.002 9.002 0 01-7.57-4.014l5.348-5.631zM12 6v6l3 1.5" />
            </svg>
        ),
    },
    {
