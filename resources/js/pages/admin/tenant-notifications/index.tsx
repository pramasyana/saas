                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-neutral-300 px-4 py-2.5 text-sm shadow-sm transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
                                />
                                {errors.active_from && <p className="mt-1 text-xs text-danger">{errors.active_from}</p>}
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl border border-neutral-300 px-4 py-2.5 text-sm shadow-sm transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30"
                                />
                                {errors.active_until && <p className="mt-1 text-xs text-danger">{errors.active_until}</p>}
                            </div>
                        </div>
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        {(n.active_from || n.active_until) && (
                                            <p className="mt-1 text-[10px] text-neutral-400">
                                                {n.active_from && `Dari ${new Date(n.active_from).toLocaleString('id-ID', { dateStyle: 'short', timeStyle: 'short' })}`}
                                                {n.active_from && n.active_until && ' — '}
                                                {n.active_until && `Sampai ${new Date(n.active_until).toLocaleString('id-ID', { dateStyle: 'short', timeStyle: 'short' })}`}
                                            </p>
                                        )}
                                    </div>
                                </div>
