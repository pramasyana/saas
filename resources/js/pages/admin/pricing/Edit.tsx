...
export default function EditPlan({ title, plan, feature_definitions }: EditPlanPageProps) {
    ...
    function handleSubmit(e: FormEvent) {
        ...
        const data: Partial<PlanFormData> = {
            name: form.name,
            slug: form.slug,
        ...
        updateMutation.mutate(
            ...
            {
                onSuccess: (res) => {
                    addToast('success', res.message || 'Plan berhasil diupdate.');
                    router.visit('/admin/pricing');
                },
                onError: (err: any) => {
                    const message = err?.response?.data?.message || 'Gagal mengupdate plan.';
            ...
            <div className="mb-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-neutral-500">Edit paket harga dan atur fitur-fiturnya.</p>
                    </div>
                </div>
            </div>
