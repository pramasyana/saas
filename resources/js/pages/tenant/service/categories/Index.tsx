...
export default function CategoriesIndex({ title, stats }: CategoriesPageProps) {
    ...
    const { data, isLoading, isError, error } = useCategories(filters);
    const deleteMutation = useDeleteCategory();
    const updateMutation = useUpdateCategory();

    const inactiveCount = stats.total_categories - stats.active;
    ...
    function handleToggleActive(id: string, current: boolean) {
        ...
        updateMutation.mutate(
            { id, data: { is_active: !current } as CategoryFormData },
    ...
    return (
        <TenantLayout>
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-neutral-900">Manajemen Kategori</h1>
                    <p className="mt-1 text-sm text-neutral-500">
                        Kelola semua kategori layanan yang terdaftar di sistem.
                    </p>
                </div>
