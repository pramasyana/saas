...
class StorePublicBookingRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'service_id' => 'required_without:package_id|uuid|exists:services,id',
            'package_id' => 'required_without:service_id|uuid|exists:packages,id',
    ...
    public function messages(): array
    {
        return [
            ...
            'service_id.required_without' => 'Layanan atau paket wajib dipilih.',
            'package_id.required_without' => 'Layanan atau paket wajib dipilih.',
