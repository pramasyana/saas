...
class UpdateLandingSettingsRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            'hero.stats' => 'nullable|array',
            'hero.stats.*.number' => 'string|max:20',
            'hero.stats.*.label' => 'string|max:100',
            'hero.stats.*.prefix' => 'string|max:10',
            'hero.stats.*.suffix' => 'string|max:10',
            ...
            'pricing.source' => 'string|in:services,custom',
